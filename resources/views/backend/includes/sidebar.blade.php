        ...
        <ul class="nav">
            ...
            @if (true)
                @if (
                    ...
                    @can('trainer_access')
                        <!-- Trainer menu intentionally hidden -->
                    @endcan
                @endif
                ...
                @if (
                    ...
                    @can('trainee_access')
                        <!-- Trainee menu intentionally hidden -->
                    @endcan
                @endif
                ...
                @if (
                    ...
                    @can('feedback_access')
                        <li class="nav-item nav-dropdown {{ active_class(Active::checkUriPattern(['user/employee*', 'user/external-employee*']), 'open') }}">
                            <a class="nav-link nav-dropdown-toggle d-flex {{ active_class(Active::checkUriPattern('admin/*')) }}" href="#">
                                <div>
                                    <i class="nav-icon fas fa-comments"></i>
                                    <span class="title">@lang('menus.backend.sidebar.feedback')</span>
                                </div>
            ...
            @can('category_access')
                    ...
                    @if ($logged_in_user->isAdmin() || $logged_in_user->can('kpi_access'))
                        <li class="nav-item nav-dropdown {{ in_array($request->segment(2), ['kpis', 'kpi-role-configs', 'kpi-targets', 'kpi-templates']) ? 'open' : '' }}">
                            ...
                            <ul class="nav-dropdown-items">
                                ...
                                @if ($logged_in_user->isAdmin() || $logged_in_user->can('kpi_role_config_access'))
                                    <li class="nav-item">
                ...
                @if (
                    ...
                    {{-- Manual assessment menu intentionally hidden --}}
                @endif
            @endcan
            ...
            @if (true)
                @if (
                    ...
                    @can('course_access')
                        <li class="nav-item nav-dropdown {{ active_class(Active::checkUriPattern(['user/courses*', 'user/lessons*', 'user/tests*', 'user/live-lessons*', 'user/live-lesson-slots*']), 'open') }}">
                            ...
                            <ul class="nav-dropdown-items">
                                ...
                                @can('assesment_access')
                                    <li class="nav-item ">
                                        <a class="nav-link {{ request()->is('user/assignments') ? 'active' : '' }}"
                                            href="{{ url('user/assignments') }}">
                                ...
                                @can('assesment_create')
                                    <li class="nav-item ">
                                        <a class="nav-link {{ request()->is('user/assignments/create') ? 'active' : '' }}"
                                            href="{{ url('user/assignments/create') }}">
            ...
            @if (true)
                @can('learning_pathway_access')
                    <li class="nav-item nav-dropdown {{ active_class(Active::checkUriPattern(['user/learning-pathways', 'user/pathway-assignments', 'user/pathway-assignments/create']), 'open') }}">
                        ...
                        <li class="nav-item nav-dropdown {{ active_class(Active::checkUriPattern(['user/employee*', 'user/external-employee*']), 'open') }}">
                            <a class="nav-link nav-dropdown-toggle d-flex align-items-center {{ active_class(Active::checkUriPattern('admin/*')) }}"
                                ...
                                <span class="title min-title" style="margin-left: 5px;">
                                    @lang('menus.backend.sidebar.all_reports')
                                </span>
                                <i class="arrow-icon-new fa fa-chevron-down ml-auto"></i>
                            </a>
            ...
            @if ($logged_in_user->hasRole('student'))
                <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(2) == 'mycourses' ? 'active' : '' }}"
                        ...
                        <span class="title">@lang('menus.backend.sidebar.my_courses')</span>
                    </a>
                </li>
            @endif
            ...
            @if ($logged_in_user->hasRole(config('access.users.admin_role')) || $logged_in_user->can('certificate_access'))
                <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(1) == 'certificates' ? 'active' : '' }}"
                        ...
                        <span class="title">@lang('menus.backend.sidebar.certificates.title')</span>
                    </a>
                </li>
            @endif
            ...
            @if (true)
                {{-- Reviews menu intentionally hidden --}}
            @endif
            ...
            @if (true)
                @if (
                    ...
                    @can('access_management_access')
                        <li class="nav-item nav-dropdown {{ active_class(Active::checkUriPattern(['admin/auth*', 'user/department*']), 'open') }}">
