                    ...
                    <div class="col-md-10">
                        <div class="password-wrapper">
                            @php
                                ...
                                $confirmationError = $errors->first('password_confirmation');
                                $passwordConfirmationMismatch =
                                    str_contains(strtolower($passwordError), 'confirmation') ||
                                    str_contains(strtolower($confirmationError), 'match');

                            @endphp
                            <input type="password" name="password" id="password-field" class="form-control {{ ($errors->has('password') && !$passwordConfirmationMismatch) ? 'is-invalid' : '' }}"
                    ...
                    <div class="col-md-10">
                        <div class="password-wrapper">
                            <input type="password" name="password_confirmation" id="password_confirmation"
                                class="form-control {{ $errors->has('password_confirmation') || $passwordConfirmationMismatch ? 'is-invalid' : '' }}"
                            ...
                            @if ($errors->has('password'))
                                ...
                                @if (str_contains(strtolower($passwordError), 'confirmation'))
                                    <div class="invalid-feedback d-block">
                                        {{ $passwordError }}
                                    </div>
                                @endif
    ...
    <script>
        ...
        function toggleConfirmPassword() {
            ...
            let icon = document.getElementById("toggle-confirm-icon");
