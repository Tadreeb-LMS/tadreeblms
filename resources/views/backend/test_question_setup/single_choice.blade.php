...
<div class="row">
    <div class="col-12 child">
        ...
        <input type="number" class="form-control" name="marks" id="marks" placeholder="Enter Marks" min="1" max="100" required oninvalid="this.setCustomValidity('Marks is required')" oninput="this.setCustomValidity('')"/>
    </div>
</div>
<div class="row">
    <div class="col-12 child">
