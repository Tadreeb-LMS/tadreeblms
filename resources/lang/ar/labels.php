...
return array(
  'backend' => array(
    ...
    'dashboard' => array(
      ...
      'select-one' => 'اختار',
      'by-due-date' => 'تاريخ الانتهاء',
      'advance-search' => 'بحث متقدم',
      'reset' => 'إعادة ضبط',
      'in-progress' => 'جاري',
      'not-stated' => 'غير مبتدئ',
      'late' => 'متأخر',
      'soon' => 'ينتهي قريباً',
...
<b> Live </b> = سيتم استخدام بيانات اعتماد Live PayPal معك لإجراء معاملات فعلية مع المستخدمين العاديين باستخدام حساب PayPal.',
    ...
    'questions' => array(
      ...
      'option_placeholder' => 'اكتب خيار الإجابة هنا...',
      'option_added' => 'تمت إضافة الخيار!',
      'no_options_added' => 'لم تتم إضافة خيارات',
      'empty_options_help' => 'املأ حقل الخيار واضغط على إضافة خيار للبدء',
      'question_options' => 'خيارات السؤال',
      'remove_option' => 'إزالة',
      'remove_option_title' => 'إزالة هذا الخيار',
      'option_required' => 'يرجى ملء حقل الخيار قبل إضافته.',
    ),
...
                         <p> إذا كنت لا تزال تعاني من الارتباك. يرجى الاتصال بنا ، وسوف نوجهك لتحديث التطبيق الخاص بك </p>',
    ...
    'certificates' => array(
      ...
      'fields' => array(
        ...
        'from_date' => 'من تاريخ',
        'to_date' => 'إلى تاريخ',
        'issue_history' => 'سجل الإصدار',
        'notes' => 'ملاحظات',
        'notify_user' => 'إشعار المستخدم عبر البريد الإلكتروني',
        'performed_at' => 'تاريخ التنفيذ',
        'performed_by' => 'تم التنفيذ بواسطة',
        'preview' => 'معاينة الشهادة',
        'reissue_notes_placeholder' => 'سبب إعادة إصدار الشهادة (اختياري)',
        'revoked_at' => 'تاريخ الإلغاء',
        'no_history' => 'لا يوجد سجل إصدار.',
        'Download-Link' => 'رابط تحميل الشهادة',
  ...
  'frontend' => array(
    ...
    'course' => array(
      ...
      'find_your_course' => 'ابحث عن دورتك التدريبية',
      'full_text' => 'نص كامل',
    ...
    'layouts' => array(
      'partials' => array(
        ...
        'search_our_courses' => 'ابحث في دوراتنا التدريبية',
    ...
    'smtp_settings' => array(
      'title' => 'إعدادات البريد الإلكتروني (SMTP)',
      'error' => 'خطأ',
      'mail_mailer' => 'مُرسل البريد',
      'mail_mailer_note' => 'اختر برنامج تشغيل البريد/المرسل لاستخدامه في إرسال رسائل البريد الإلكتروني (يوصى بـ SMTP للإنتاج).',
      'mail_host' => 'خادم SMTP',
      'mail_host_note' => 'أدخل عنوان خادم SMTP (مثال: smtp.gmail.com, smtp.office365.com).',
      'mail_port' => 'منفذ SMTP',
      'mail_port_note' => 'المنافذ الشائعة: 587 (TLS)، 465 (SSL)، 25 (غير آمن). استخدم 587 لمعظم خوادم SMTP.',
      'mail_username' => 'اسم مستخدم SMTP',
      'mail_username_note' => 'أدخل اسم مستخدم SMTP (عادةً عنوان بريدك الإلكتروني).',
      'mail_password' => 'كلمة مرور SMTP',
      'mail_password_placeholder' => 'أدخل كلمة مرور جديدة',
      'mail_password_note' => 'أدخل كلمة مرور SMTP أو كلمة مرور التطبيق. اتركه فارغاً للاحتفاظ بكلمة المرور الحالية.',
      'password_exists' => 'تم تكوين كلمة مرور حالياً. اتركه فارغاً للاحتفاظ بكلمة المرور الحالية.',
      'mail_encryption' => 'التشفير',
      'mail_encryption_note' => 'يوصى بـ TLS للمنفذ 587. استخدم SSL للمنفذ 465. اختر لا شيء فقط إذا كان الخادم لا يدعم التشفير.',
      ...
      'save_error' => 'فشل في حفظ إعدادات SMTP',
      'test_email_title' => 'اختبار تكوين البريد الإلكتروني',
      'test_email_info' => 'أرسل بريداً إلكترونياً تجريبياً للتحقق من أن تكوين SMTP يعمل بشكل صحيح. تأكد من حفظ الإعدادات قبل الاختبار.',
      'test_email_address' => 'عنوان البريد الإلكتروني التجريبي',
      'test_email_note' => 'أدخل عنوان البريد الإلكتروني الذي تريد استلام البريد التجريبي عليه.',
      'send_test_email' => 'إرسال بريد تجريبي',
      'test_email_success' => 'تم إرسال البريد التجريبي بنجاح! يرجى التحقق من صندوق الوارد.',
      'test_email_error' => 'فشل في إرسال البريد التجريبي',
      'test_email_subject' => 'بريد تجريبي - تكوين SMTP',
      'test_email_body' => 'هذا بريد تجريبي للتحقق من أن تكوين SMTP يعمل بشكل صحيح. إذا استلمت هذا البريد، فإن إعدادات SMTP مكونة بشكل صحيح.',
      'saving' => 'جارٍ الحفظ...',
      'sending' => 'جارٍ الإرسال...',
      'smtp_enabled' => 'تفعيل SMTP',
      'smtp_enabled_note' => 'قم بالتبديل لتفعيل أو تعطيل إرسال البريد الإلكتروني عبر SMTP. عند التعطيل، لن يتم إرسال أي رسائل بريد إلكتروني من النظام.',
      'smtp_disabled_warning' => 'SMTP معطل حالياً. لن يتم إرسال أي رسائل بريد إلكتروني من النظام حتى يتم تفعيل SMTP.',
      'smtp_disabled_save_success' => 'تم تعطيل SMTP. لن يتم إرسال أي رسائل بريد إلكتروني من النظام.',
    ),
  ),
  'teacher' => array(
