...
return array(
  ...
  array(
    ...
    array(
      ...
      array(
        ...
        'popular' => 'Popular',
        'teachers' => 'Trainers',
        'external_students' => 'External Students',
        'internal_students' => 'Internal Students',
        'category' => 'Category',
        'title' => 'Title',
        'slug' => 'Slug',
      ...
      'add_teachers' => 'Add Trainers',
      'add_internal_students' => 'Add Internal Students',
      'add_external_students' => 'Add External Students',
      'add_categories' => 'Add Categories',
      'slug_placeholder' => 'Input slug or it will be generated automatically',
      'select_category' => 'Select Category',
      'select_teachers' => 'Select Trainers',
      'select_internal_students' => 'Select Internal Students',
      'select_external_students' => 'Select External Students',
    ...
    array(
      ...
      'custom_js' => 'Custom JS',
      'teacher_commission_rate' => 'Trainer Commission Rate',
      ...
      'counter' => 'Counter',
      'counter_note' => '<b>Static</b> =  Manually add data for counter. Please enter exact text you want to display on frontend counter section,<br> <b>Database/Real</b> = It will take real data from database for all the fields (Students enrolled, Total Courses, Total Trainers)',
      'total_students' => 'Enter Total Students. Ex: 1K, 1Million, 1000 etc.',
      'total_courses' => 'Enter Total Courses. Ex: 1K, 1000 etc.',
      'total_teachers' => 'Enter Total Trainers. Ex: 1K, 1000 etc.',
    ...
    array(
      ...
      'type-your-course' => 'Type your course',
      ...
      'soon' => 'Soon',
      'due_date' => 'Due Date',
      'employees_requests' => 'Employees Requests',
      'title' => 'Dashboard',
      'students' => 'Students',
      'trending' => 'Trending',
      'teachers' => 'Trainers',
    ...
    array(
      ...
      array(
        ...
        'notes' => 'Notes',
        'reissue_notes_placeholder' => 'Reason for reissuing certificate (optional)',
        'notify_user' => 'Notify user by email',
        'performed_by' => 'Performed By',
        'performed_at' => 'Performed At',
        'revoked_at' => 'Revoked At',
        'no_history' => 'No issue history available.',
    ...
    'license_settings' => [
      ...
      'not_configured' => 'License Server Not Configured',
      'not_configured_note' => 'Please add the following environment variables to your .env file:',
      'limit_exceeded' => 'User Limit Exceeded',
      'limit_exceeded_note' => 'You have :current active users but your license only allows :max users.',
      'limit_warning' => 'User Limit Warning',
      'limit_warning_note' => 'You are approaching your user limit. Currently :current of :max users.',
      ...
      'support_until' => 'Support Valid Until',
      ...
      'no_license_note' => 'Enter your license key below to activate your license. Please contact <a href="mailto:info@tadreeblms.com">support@tadreeblms.com</a> to purchase new license.',
      ...
      'license_key_placeholder' => 'Enter your license key here...',
      'license_key_note' => 'Your license key was provided when you purchased the software.',
      'activate' => 'Activate',
      'activating' => 'Activating...',
      'activation_failed' => 'License activation failed.',
      'validation_failed' => 'License validation failed.',
      'remove_confirm' => 'Are you sure you want to remove this license?',
      'remove_failed' => 'Failed to remove license.',
      'license_notice' => 'OverLimit',
    ...
    'smtp_settings' => array(
      ...
      'mail_mailer_note' => 'Choose the mail driver/mailer to use for sending emails (SMTP is recommended for production).',
      'mail_host' => 'SMTP Host',
      'mail_host_note' => 'Enter the SMTP server address (e.g., smtp.gmail.com, smtp.office365.com).',
      'mail_port' => 'SMTP Port',
      'mail_port_note' => 'Common ports: 587 (TLS), 465 (SSL), 25 (insecure). Use 587 for most SMTP servers.',
      'mail_username' => 'SMTP Username',
      'mail_username_note' => 'Enter the SMTP username (usually your email address).',
      'mail_password' => 'SMTP Password',
      'mail_password_placeholder' => 'Enter new password',
      'mail_password_note' => 'Enter the SMTP password or app password. Leave blank to keep the current password.',
      'password_exists' => 'A password is currently configured. Leave blank to keep the current password.',
      'mail_encryption' => 'Encryption',
      'mail_encryption_note' => 'TLS is recommended for port 587. Use SSL for port 465. Choose None only if the server does not support encryption.',
      'mail_from_address' => 'From Address',
      'mail_from_address_note' => 'This address will appear as the sender for all outgoing emails.',
      'mail_from_name' => 'From Name',
      'mail_from_name_note' => 'This name will appear as the sender name for all outgoing emails.',
      'save_success' => 'SMTP settings saved successfully.',
      'save_error' => 'Failed to save SMTP settings',
      'test_email_title' => 'Test Email Configuration',
      'test_email_info' => 'Send a test email to verify that the SMTP configuration is working correctly. Make sure to save settings before testing.',
      'test_email_address' => 'Test Email Address',
      'test_email_note' => 'Enter the email address where you want to receive the test email.',
      'send_test_email' => 'Send Test Email',
      'test_email_success' => 'Test email sent successfully! Please check your inbox.',
      'test_email_error' => 'Failed to send test email',
      'test_email_subject' => 'Test Email - SMTP Configuration',
      'test_email_body' => 'This is a test email to verify that your SMTP configuration is working correctly. If you received this email, your SMTP settings are configured properly.',
      'saving' => 'Saving...',
      'sending' => 'Sending...',
      'smtp_enabled' => 'Enable SMTP',
      'smtp_enabled_note' => 'Toggle to enable or disable SMTP email sending. When disabled, no emails will be sent from the system.',
      'smtp_disabled_warning' => 'SMTP is currently disabled. No emails will be sent from the system until SMTP is enabled.',
      'smtp_disabled_save_success' => 'SMTP has been disabled. No emails will be sent from the system.',
    ),
  ),
  'general' =>
  array(
  ...
  array(
    ...
    'course' =>
    array(
      'start_assesment' => 'Start Assesment',
      're_attempt_assesment' => 'Re Attempt Assesment',
    ...
    array(
      ...
      'popular_teachers' => '<span>Popular</span> Trainers',
    ...
    array(
      ...
      'students' => 'Students',
      'title' => 'Trainers',
      'courses_by_teacher' => 'Courses <span>By Trainer.</span>',
      'course_detail' => 'Course Detail',
    ),
    'user' =>
    array(
  ...
  'teacher' =>
  array(
    'teacher_register' => 'Register as Trainer? Click Here',
    'teacher_register_box_title' => 'Trainer Register',
